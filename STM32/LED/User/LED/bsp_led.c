...
void LED_GPIO_Config (void)
{
        ...
        GPIO_Initstuct.GPIO_Pin = LED_R_GPIO_PIN| LED_G_GPIO_PIN|LED_B_GPIO_PIN|LED_D_GPIO_PIN   ;
        ...
        GPIO_Init(LED_D_GPIO_PORT, &GPIO_Initstuct);

        GPIO_ResetBits(LED_R_GPIO_PORT, LED_G_GPIO_PIN);        //关闭所有的灯，，进行初始化
